...
public:
    ...
    Q_PROPERTY(VideoManager*        customedVideoManager            READ    customedVideoManager            CONSTANT)
    ...
    VideoManager*           customedVideoManager()  { return _customedVideoManager; }
...
private:
    ...
    VideoManager*           _customedVideoManager   = nullptr;
